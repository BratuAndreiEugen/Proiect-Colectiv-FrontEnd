import {
  BsEmojiAngryFill,
  BsEmojiExpressionlessFill, BsEmojiGrinFill, BsEmojiHeartEyesFill,
  BsEmojiNeutralFill,
  BsEmojiSmileFill,
...
const RatingDisplay = ({ rating, type }: RatingDisplayProps) => {
  ...
  const color = type === "healthy" ? "#68c468" : type === "tasty" ? "#fb8846" : "#dad74e";

  return (
    <div style={{color: color, display: "flex", alignItems: "center", gap: "7px", marginTop: "-10px"}}>
      {displayedRating <= 1
